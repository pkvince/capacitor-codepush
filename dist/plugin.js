    ...
    class HttpRequester {
        ...
        request(verb, url, callbackOrRequestBody, callback) {
            ...
            core.CapacitorHttp.request(options).then((nativeRes) => {
                ...
                const response = { statusCode: nativeRes.status, body: nativeRes.data };
    ...
    class RemotePackage extends Package {
        ...
        download(downloadProgress) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                let fullPath = yield FileUtil.getUri(filesystem.Directory.Data, file);
                try {
                    ...
                    if (typeof downloadProgress === "function") {
                        progress = true;
                        listener = yield filesystem.Filesystem.addListener("progress", (e) => {
